Pod::Spec.new do |s|
  ...
  s.homepage     = 'https://github.com/Brumanuel/CocoaConnectifSDK'
  s.license      = { :type => 'MIT',:text => 'https://opensource.org/licenses/MIT' }
  s.author       = { 'Connectif' => 'support@connectif.ai' }
  s.source       = { :http => 'https://github.com/Brumanuel/CocoaConnectifSDK/releases/download/1.0.0/ConnectifSDK.xcframework.zip' }
